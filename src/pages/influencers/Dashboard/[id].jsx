import { BlockStack, Page, Tabs, InlineStack, Button } from "@shopify/polaris";
...
function InfluencerDashboard() {
  ...
  const renderTabContent = () => {
    switch (selected) {
      case 0:
        return <Overview selectedDates={selectedDates} />;
      case 1:
        return <Links selectedDates={selectedDates} />;
      case 2:
        return <Payouts ref={payoutsRef} />;
      default:
        return <Overview selectedDates={selectedDates} />;
    }
  };
  ...
  return (
    <Page
      ...
      backAction={{
        content: "Influencer",
        url: `/influencers${window.location.search}`,
      }}
    >
      <BlockStack gap="400">
