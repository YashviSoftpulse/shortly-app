...
export declare type LabelFormatter = (value: string | number | null) => string;
...
export declare type Shape = 'Line' | 'Bar';
export declare type LineStyle = 'solid' | 'dotted';
...
export declare type BoundingRect = Position & Dimensions;
...
export declare type ChartType = 'default' | 'stacked';
...
export declare type LineChartDataSeriesWithDefaults = DataSeries & {
    color: Color;
    strokeDasharray?: string;
...
export declare type StackedValues = Series<{
    [key: string]: number;
}, string>[];
export declare enum InternalChartType {
    Bar = "Bar",
    Combo = "Combo",
    Line = "Line"
}
...
export declare type ErrorBoundaryResponse = (error: Error, errorInfo: ErrorInfo) => void;
export {};
