...
var AnimatedLine = require('./components/AnimatedLine/AnimatedLine.js');
var getColorVisionStylesForActiveIndex = require('../../utilities/getColorVisionStylesForActiveIndex.js');
var AnimatedArea = require('./components/AnimatedArea/AnimatedArea.js');
var Area = require('./components/Area/Area.js');
...
function LineSeries({
  ...
  const previousData = usePrevious.usePrevious(data);
  const {
    shouldAnimate
  ...
  const lineGenerator = d3Shape.line().x((_, index) => xScale == null ? 0 : xScale(index)).y(({
    value
  }) => yScale(value !== null && value !== void 0 ? value : 0)).defined(({
    value
  }) => value != null);
  const areaGenerator = d3Shape.area().x((_, index) => xScale(index)).y0(svgDimensions.height).y1(({
    value
  }) => yScale(value !== null && value !== void 0 ? value : 0)).defined(({
    value
  }) => value != null);
  ...
  if (selectedTheme.line.hasSpline) {
    lineGenerator.curve(curveStepRounded.curveStepRounded);
    areaGenerator.curve(curveStepRounded.curveStepRounded);
  }
  ...
  const id = react.useMemo(() => uniqueId.uniqueId('line-series'), []);
  const immediate = !shouldAnimate;
  const lineGradientColor = getGradientFromColor.getGradientFromColor(color);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(react.Fragment, {
    children: /*#__PURE__*/jsxRuntime.jsxs(AnimatedGroup, {
      opacity: 1,
      style: {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsxs(Defs, {
        children: [/*#__PURE__*/jsxRuntime.jsx(LinearGradientWithStops.LinearGradientWithStops, {
          ...
          id: `mask-${id}`,
          children: dataIsValidForAnimation ? /*#__PURE__*/jsxRuntime.jsx(AnimatedLine.AnimatedLine, {
            lastY: lastY,
            delay: delay,
      ...
      }), showArea && (dataIsValidForAnimation ? /*#__PURE__*/jsxRuntime.jsx(AnimatedArea.AnimatedArea, {
        ...
        delay: delay,
        immediate: immediate
      }) : /*#__PURE__*/jsxRuntime.jsx(Area.Area, {
        series: data,
        areaPath: areaPath,
        type: type
      })), /*#__PURE__*/jsxRuntime.jsx(Rect, {
        x: "0",
        y: (strokeWidth + constants.SHAPE_ANIMATION_HEIGHT_BUFFER) * -1,
        width: svgDimensions.width,
        height: svgDimensions.height + strokeWidth * 2 + constants.SHAPE_ANIMATION_HEIGHT_BUFFER,
        ...
        ...getColorVisionEventAttrs.getColorVisionEventAttrs({
          type: constants.COLOR_VISION_SINGLE_ITEM,
          index
        })
      })]
    })
