...
function getAlteredVerticalBarPosition(props) {
  ...
  if (!props.isPerformanceImpacted) {
    if (newPosition.vertical === types.TooltipVerticalOffset.Inline) {
      newPosition.horizontal = types.TooltipHorizontalOffset.Left;
      const inline = getInlinePosition(y, props);
      y = inline.value;
    }

    if (newPosition.vertical === types.TooltipVerticalOffset.Center) {
      const verticalCenter = getVerticalCenterPosition(y, props);
      y = verticalCenter.value;
    }

    if (newPosition.vertical === types.TooltipVerticalOffset.Above) {
    ...
    if (newPosition.vertical === types.TooltipVerticalOffset.Below) {
  ...
  if (newPosition.horizontal === types.TooltipHorizontalOffset.Left) {
    const left = getLeftPosition(x, props);

    if (left.wasOutsideBounds) {
      newPosition.horizontal = types.TooltipHorizontalOffset.Right;
    } else {
      x = left.value;
    }
  }

  if (newPosition.horizontal === types.TooltipHorizontalOffset.Right) {
    const right = getRightPosition(x, props);
    x = right.value;
  }

  if (newPosition.horizontal === types.TooltipHorizontalOffset.Center) {
...
exports.getAbovePosition = getAbovePosition;
exports.getAlteredVerticalBarPosition = getAlteredVerticalBarPosition;
exports.getBelowPosition = getBelowPosition;
exports.getCenterPosition = getCenterPosition;
exports.getInlinePosition = getInlinePosition;
exports.getLeftPosition = getLeftPosition;
exports.getRightPosition = getRightPosition;
exports.getVerticalCenterPosition = getVerticalCenterPosition;
