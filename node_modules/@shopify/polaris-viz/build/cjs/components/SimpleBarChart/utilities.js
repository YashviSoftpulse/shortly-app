...
var estimateTrendIndicatorWidth = require('../TrendIndicator/utilities/estimateTrendIndicatorWidth.js');
...
function getLongestTrendIndicator(data, highestPositive, lowestNegative) {
  const longestTrendIndicator = data.reduce((longestTrendIndicator, series) => {
    ...
    for (const [index, trend] of trendEntries) {
      ...
      if ((dataPoint === null || dataPoint === void 0 ? void 0 : dataPoint.value) === highestPositive) {
        ...
        longestTrendIndicator.positive = estimateTrendIndicatorWidth.estimateTrendIndicatorWidth((_trend$value = trend.value) !== null && _trend$value !== void 0 ? _trend$value : '').totalWidth;
      } else if ((dataPoint === null || dataPoint === void 0 ? void 0 : dataPoint.value) === lowestNegative) {
        var _trend$value2;

        longestTrendIndicator.negative = estimateTrendIndicatorWidth.estimateTrendIndicatorWidth((_trend$value2 = trend.value) !== null && _trend$value2 !== void 0 ? _trend$value2 : '').totalWidth;
      }
    }
  ...
  if (longestTrendIndicator.positive > 0) {
    longestTrendIndicator.positive += polarisVizCore.HORIZONTAL_BAR_LABEL_OFFSET;
  }

  if (longestTrendIndicator.negative > 0) {
    longestTrendIndicator.negative += polarisVizCore.HORIZONTAL_BAR_LABEL_OFFSET;
  }

  return longestTrendIndicator;
}

exports.getLongestTrendIndicator = getLongestTrendIndicator;
