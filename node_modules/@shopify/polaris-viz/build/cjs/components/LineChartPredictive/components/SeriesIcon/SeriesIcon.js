...
var SeriesIcon$1 = require('./SeriesIcon.scss.js');
var jsxRuntime = require('react/jsx-runtime');

function SeriesIcon({
  color
}) {
  const id = React.useMemo(() => polarisVizCore.uniqueId('SeriesIcon'), []);
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    className: SeriesIcon$1["default"].IconContainer,
    children: /*#__PURE__*/jsxRuntime.jsxs("svg", {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx("path", {
        ...
        fill: polarisVizCore.isGradientType(color) ? `url(#${id})` : color
      }), polarisVizCore.isGradientType(color) ? /*#__PURE__*/jsxRuntime.jsx("defs", {
