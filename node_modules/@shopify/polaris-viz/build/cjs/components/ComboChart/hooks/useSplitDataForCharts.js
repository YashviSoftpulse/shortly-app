...
function useSplitDataForCharts(data, colors) {
  return React.useMemo(() => {
    ...
    const chartColors = [colors.slice(0, firstLength), colors.slice(firstLength)];
    const barChartColors = chartColors[barChartDataIndex];
    const lineChartColors = chartColors[barChartDataIndex === 0 ? 1 : 0]; // Assume we have 3 bars and 2 lines.
    //
...
exports.useSplitDataForCharts = useSplitDataForCharts;
