...
export declare const MissingEndData: Story<LineChartProps>;
export declare const MissingStartData: Story<LineChartProps>;
export declare const MissingMiddleData: Story<LineChartProps>;
export declare const MissingRandomData: Story<LineChartProps>;
export declare const MissingRandomSingleData: Story<LineChartProps>;
//# sourceMappingURL=MissingData.chromatic.stories.d.ts.map