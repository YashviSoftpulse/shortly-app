...
export declare const DefaultYScaleWidth: Story<LineChartProps>;
export declare const FixedYScaleWidth: Story<LineChartProps>;
//# sourceMappingURL=FixedYScaleWidth.chromatic.stories.d.ts.map