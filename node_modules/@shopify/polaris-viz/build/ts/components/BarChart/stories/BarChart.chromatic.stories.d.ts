...
export declare const UniqueStackedValues: Story<BarChartProps>;
export declare const BadTheme: Story<BarChartProps>;
//# sourceMappingURL=BarChart.chromatic.stories.d.ts.map