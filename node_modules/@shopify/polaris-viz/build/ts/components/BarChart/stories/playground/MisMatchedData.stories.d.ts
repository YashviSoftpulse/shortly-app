...
export declare const MisMatchedData: Story<BarChartProps>;
export declare const MisMatchedWebData: Story<BarChartProps>;
export declare const MisMatchedLinearData: Story<BarChartProps>;
//# sourceMappingURL=MisMatchedData.stories.d.ts.map