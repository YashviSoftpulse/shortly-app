...
import { HORIZONTAL_SPACE_BETWEEN_SETS, clamp, HORIZONTAL_GROUP_LABEL_HEIGHT, HORIZONTAL_SPACE_BETWEEN_SINGLE, HORIZONTAL_SPACE_BETWEEN_CHART_AND_AXIS } from '@shopify/polaris-viz-core';
...
function useHorizontalBarSizes({
  ...
  return useMemo(() => {
    const spaceBetweenXAxis = isSimple ? 0 : HORIZONTAL_SPACE_BETWEEN_CHART_AND_AXIS; // Push the container taller to line up last bar
